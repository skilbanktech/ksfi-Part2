...
<noscript></noscript>
<div align="center">
	<form id="searchStatus" action="DisplaySearchPayment.php" autocomplete="off" enctype="multipart/form-data" method="post" name="Form" onsubmit="return SearchAppStatus(this)" style="height: 100%;">
