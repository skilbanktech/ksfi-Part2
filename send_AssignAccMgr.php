...
//fetch studentDetail
$select_record11="select reference_id, AccManager from student_details where reference_id='".$id."'";
$select_query11=mysql_query($select_record11) or die(mysql_error());


if((mysql_num_rows($select_query11) !=0))
{
    $add_new11="update student_details set AccManager='$Accpartnername' where reference_id='$id'";
...
if($partnername!='')
{
  ...
  //-----------------------------------------------  student_details  -------------------------------------------------------------------
         ...
         $select_record="select reference_id,firstname,middlename,lastname,dob,email,password,address,street1,street2,state,district,city,pincode,stdcode,phone,mobile from student_details where reference_id='".$id."'";
	...
	$col = array('reference_id','firstname','middlename','lastname','dob','email','password','address','street1','street2','state','district','city','pincode','stdcode','phone','mobile');
